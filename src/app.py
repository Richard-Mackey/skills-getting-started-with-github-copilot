...
activities = {
    ...
    "Basketball Club": {
        "description": "Develop basketball skills and play in weekly scrimmages",
    ...
    "Art Club": {
        ...
        "max_participants": 16,
        "participants": ["ada@mergington.edu", "nora@mergington.edu"]
    },
    "Drama Club": {
    ...
    "Science Olympiad": {
        ...
        "max_participants": 20,
        "participants": ["kate@mergington.edu", "simon@mergington.edu"]
    },
    "Debate Team": {
        "description": "Build public speaking and critical thinking skills",
        "schedule": "Tuesdays, 4:30 PM - 6:00 PM",
        "max_participants": 18,
        "participants": ["leah@mergington.edu", "mike@mergington.edu"]
    }
}
